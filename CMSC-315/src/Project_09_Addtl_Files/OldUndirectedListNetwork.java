...
public class OldUndirectedListNetwork<Vertex> extends OldDirectedListNetwork<Vertex> implements Network<Vertex>, Iterable<Vertex>
{
    /**
     * Initialized this Network object to be empty. 
     */
    public OldUndirectedListNetwork()
    {
            super();
    } // default constructor
     ...
     */
    public OldUndirectedListNetwork (int capacity)
    {
        super(capacity);
    } // constructor
     ...
     */
    public OldUndirectedListNetwork (OldUndirectedListNetwork<Vertex> network)
    {
            super(network);
    } // copy constructor
