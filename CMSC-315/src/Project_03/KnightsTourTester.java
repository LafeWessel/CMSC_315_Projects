...
public class KnightsTourTester {
    ...
    public static void main(String[] args) {
		...
		/*
		 * System.out.println("What size board?"); BOARDSIZE=in.nextInt();
		 * 
		 * System.out.println("What starting row?"); Y_START_POS =in.nextInt();
		 * 
		 * System.out.println("What starting column?"); X_START_POS=in.nextInt();
		 * 
